...
def load_spherical_swe(
    ...
    for (
        ...
        test_dataset = SphericalSWEDataset(
            dims=res, num_examples=n_test, device=device)
...
class SphericalSWEDataset(torch.utils.data.Dataset):
    ...
    def __init__(
            ...
            normalize=True,
            stream=None):
        # Caution: this is a heuristic which can break and lead to diverging
        # results
